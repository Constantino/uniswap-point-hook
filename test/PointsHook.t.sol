...
contract TestPointsHook is Test, Deployers, ERC1155TokenReceiver {
    ...
    function test_swap() public {
        ...
        // We should get 5% of 0.001 * 10**18 points
        // = 2 * 10**13
        ...
        assertEq(pointsBalanceAfterSwap - pointsBalanceOriginal, 2 * 10 ** 13);
    }
    ...
    function test_swap2() public {
        ...
        // Now we swap
        // We will swap 0.001 ether for tokens
        // We should get 4% of 0.001 * 10**18 points
        // = 4 * 10**13
        swapRouter.swap{value: 0.001 ether}(
            key,
            SwapParams({
